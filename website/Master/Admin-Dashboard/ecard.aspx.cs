...
public partial class e_card : System.Web.UI.Page
{
    ...
    private void _showUpdate(int id)
    {
        ...
        ecardClass _ecard = new ecardClass();
        rpt_update.DataSource = _ecard.getE_cardByID(id);
        rpt_update.DataBind();
    }
    ...
    private void _showDelete(int id)
    {
        ...
        rpt_delete.DataSource = objEcard.getE_cardByID(id);
        rpt_delete.DataBind();
    }
    ...
    private void _subRebind()
    {
        ...
        rpt_all.DataSource = objEcard.getE_card();
        rpt_all.DataBind();
    ...
    {
        if (flag)
            lbl_message.Text = "E-card " + str + " was successful";
        else
            lbl_message.Text = "Sorry, unable to " + str + " E-card";
    }
}