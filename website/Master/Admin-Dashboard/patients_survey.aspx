<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="patients_survey.aspx.cs" Inherits="patients_survey" Theme="mainStyle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_admin_d" runat="Server">
    ...
    <div class="col-sm-8 admin_form">
        ...
        <asp:Label ID="admin_lbl_header" runat="server" Text="Patients Survey" CssClass="col-lg-9 admin_header"/>
